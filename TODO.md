...
TODO:
1. Accept Order (на стороне ретсоран)
1. Всё сложное что нейронка нахуевертила и удалить и написать с кайфом
1. И так далее
...
handler - у сервисов (почти всегда)

service/pkg может всё
ручки у каждого сервиса свои

в pkg специфичное для сервиса - говно.
